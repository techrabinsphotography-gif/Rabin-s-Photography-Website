...
import { Camera, Smartphone, Video, Zap, Star, Rocket, Sparkles, Check, CheckCircle } from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="mt-6 flex flex-col items-center gap-4">
                            ...
                            <div className="flex gap-6 mt-4 justify-center flex-wrap px-4">
                                ...
                                >
                                    <p className="text-sm font-bold text-blue-900 flex items-center gap-2"><Smartphone className="w-4 h-4" /> Live Preview</p>
                                </motion.div>
                                ...
                                >
                                    <p className="text-sm font-bold text-[#ff4f5a] flex items-center gap-2"><Video className="w-4 h-4" /> 4K Capture</p>
                                </motion.div>
                                ...
                                >
                                    <p className="text-sm font-bold text-purple-900 flex items-center gap-2"><Zap className="w-4 h-4" /> Instant Delivery</p>
                                </motion.div>
                            </div>
                        </div>
                    </motion.div>
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                ...
                <div className="space-y-8">
                    ...
                    >
                        ...
                        <a href="https://maps.app.goo.gl/71qkaUofE1KxZ1zt6" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 block">
