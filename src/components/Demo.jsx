          ...
          >
            ...
            <div className="mt-6 flex flex-col items-center gap-4">
              ...
              <div className="flex gap-3 mt-4 justify-center flex-wrap px-4">
                ...
                >
                  <p className="text-xs font-bold text-blue-900 flex items-center gap-2 whitespace-nowrap">
                    <Package className="w-3 h-3" /> Package Customization
                  </p>
                </motion.div>
                ...
                >
                  <p className="text-xs font-bold text-[#ff4f5a] flex items-center gap-2 whitespace-nowrap">
                    <Headphones className="w-3 h-3" /> 24/7 Customer Support
                  </p>
                </motion.div>
                ...
                >
                  <p className="text-xs font-bold text-purple-900 flex items-center gap-2 whitespace-nowrap">
