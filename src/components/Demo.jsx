...
const CounterStat = ({ end, suffix = "", color, label }) => {
  ...
  return (
    <div ref={countRef} className="text-center">
      <p
        className={`text-4xl md:text-5xl font-black bg-gradient-to-r ${color} bg-clip-text text-transparent`}
      >
        {count}
        {suffix}
      </p>
  ...
  return (
    <>
      ...
      <div className="relative w-full min-h-screen bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden pt-20 pb-20">
        ...
        <div
          className="absolute bottom-10 right-10 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl animate-pulse"
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-6">
          ...
          >
            <p className="text-[#ff4f5a] text-sm font-semibold tracking-widest uppercase">
              Est. 2013 • Award-Winning Photography company
            </p>
          </motion.div>
          ...
          >
            ...
            <span className="text-[#ff4f5a] font-semibold">
              all in one app.
            </span>
          </motion.p>
      ...
      <section
        id="phone"
        className="w-full min-h-screen bg-slate-50 flex flex-col items-center py-24 relative overflow-hidden"
      >
        {/* Heading */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
            Professional Photography <br className="hidden md:block" />{" "}
            <span className="bg-gradient-to-r from-blue-600 to-[#ff4f5a] bg-clip-text text-transparent">
              at Your Fingertips
            </span>
          </h2>
          <p className="mt-6 text-lg text-gray-600 max-w-xl mx-auto">
            Experience professional capture, intelligent editing, and seamless
            delivery - all in one powerful app built for modern photographers.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="relative w-[300px] h-[600px] bg-gradient-to-b from-gray-900 to-black rounded-[45px] p-3 shadow-2xl border-[8px] border-gray-900 group">
              ...
              <div className="w-full h-full bg-white rounded-[38px] overflow-hidden relative shadow-inner">
                ...
                <div className="absolute top-0 w-full h-14 bg-gradient-to-r from-white via-white/95 to-white backdrop-blur-xl z-10 flex items-end justify-center pb-2 border-b border-gray-100/50">
                  <span className="font-bold text-sm bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">
                    Rabin's Photography
                  </span>
                </div>
            ...
            <div className="mt-6 flex flex-col items-center gap-4">
              ...
              <div className="flex gap-6 mt-4 justify-center flex-wrap px-4">
                ...
                >
                  <p className="text-sm font-bold text-[#ff4f5a] flex items-center gap-2">
                    <Video className="w-4 h-4" /> 4K Capture
                  </p>
                </motion.div>
              ...
              icon={
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M7.217 10.907a2.25 2.25 0 1 0 0 2.186m0-2.186c.18.324.287.696.287 1.093 0 .397-.107.769-.287 1.093m0-2.186 9.566-5.314m-9.566 7.5 9.566 5.314m0 0a2.25 2.25 0 1 0 3.935 2.186 2.25 2.25 0 0 0-3.935-2.186Zm0-12.814a2.25 2.25 0 1 0 3.933-2.185 2.25 2.25 0 0 0-3.933 2.185Z"
                  />
                </svg>
              }
              delay={0.3}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Everything you need in one app—no hassles, no hidden fees, just
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            ...
            >
              ...
              <p className="text-gray-700">
                Professional photographers with years of experience. Every shoot
                delivers premium, publication-ready results—not amateur
                snapshots.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700">
                One-app experience from booking to delivery. Real-time updates,
                live project tracking, and instant access to your photos the
            ...
            >
              ...
              <p className="text-gray-700">
                Modern app-powered studio with transparent pricing, secure
                galleries, and hassle-free management. Photography made
      ...
      <section
        id="gold-membership"
        className="w-full min-h-screen bg-black flex flex-col items-center justify-center text-center px-6 relative overflow-hidden py-32 mx-4 rounded-[3rem]"
      >
        ...
        >
          ...
          >
            ...
            <span className="text-green-400 text-sm font-bold tracking-[0.3em] uppercase">
              100% FREE FEATURES
            </span>
          </motion.div>
          ...
          <p className="mt-2 text-white/90 text-xl md:text-2xl font-medium tracking-wide max-w-2xl leading-relaxed">
            ...
            — Professional Services, Priority Booking & Unlimited Cloud Storage
            Included
          </p>
          ...
          <div className="relative">
            ...
            {showGoldPopup && (
              ...
              >
                ...
                <p className="font-bold text-lg mb-1">Coming Soon!</p>
                <p className="text-xs text-gray-500">
                  Premium memberships launching soon!
                </p>
              </motion.div>
            )}
          </div>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-7xl px-4 relative z-10">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 leading-relaxed">
                Book anytime through the app. No limits, no queues — the studio
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 leading-relaxed">
                40% off on premium editing & color grading. Get magazine-quality
                results every time.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 leading-relaxed">
                Skip the waitlist. Get instant booking confirmations and
                first-choice time slots.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 leading-relaxed">
                All your photos securely stored forever. Access them anytime,
...
const ContactSection = () => {
  ...
  return (
    <section
      id="contact"
      className="w-full py-32 bg-gradient-to-br from-slate-900 via-gray-900 to-black relative overflow-hidden"
    >
        ...
        <div className="space-y-8">
          ...
          >
            <a
              ...
              className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 cursor-pointer"
            >
            ...
            <a
              href="https://share.google/1WcG0bG2lXvEOZxPf"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 block"
            >
...
const DownloadAppSection = () => {
  ...
  return (
    <section
      id="download-app"
      className="w-full flex justify-center items-center py-24 bg-white"
    >
      <motion.div
      ...
      >
        ...
        <div className="max-w-2xl z-10 text-center md:text-left mt-12 md:mt-0">
          ...
          <p className="mt-6 text-lg text-gray-600">
            Experience seamless photo booking, live previews, and professional
            editing only on the{" "}
            <span className="text-blue-600 font-semibold">
              Rabin's Photography app.
            </span>
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#ff4f5a]/10 to-orange-100/10 border border-[#ff4f5a]/20">
              ...
              <span className="text-[#ff4f5a] font-bold tracking-widest text-xs uppercase">
                Why Choose Rabin's Photography
              </span>
            </div>
            ...
            >
              Since 2013, Rabin's Photography has been trusted by hundreds of
              clients across Kolkata. Now, we've revolutionized the experience
              with our app—one platform to book, track, and receive your
              photography deliverables without the complexity.
            </motion.p>
            ...
            >
              <div className="flex items-start gap-4 p-4 rounded-xl bg-white/50 border border-gray-200/50 backdrop-blur-sm hover:bg-white/80 transition-all duration-300">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-[#ff4f5a] to-orange-600 flex items-center justify-center text-white text-sm font-bold">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Schedule sessions in seconds
                  </p>
                </div>
              </div>

              <div className="flex items-start gap-4 p-4 rounded-xl bg-white/50 border border-gray-200/50 backdrop-blur-sm hover:bg-white/80 transition-all duration-300">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-blue-600 to-blue-500 flex items-center justify-center text-white text-sm font-bold">
                  <Check className="w-4 h-4" />
                </div>
                <div>
                  <p className="font-semibold text-gray-900">
                  ...
                  <p className="text-sm text-gray-600">
                    Monitor status from shoot to delivery
                  </p>
                </div>
              </div>

              <div className="flex items-start gap-4 p-4 rounded-xl bg-white/50 border border-gray-200/50 backdrop-blur-sm hover:bg-white/80 transition-all duration-300">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-purple-600 to-purple-500 flex items-center justify-center text-white text-sm font-bold">
                  <Check className="w-4 h-4" />
                </div>
                <div>
                  <p className="font-semibold text-gray-900">Secure Delivery</p>
                  <p className="text-sm text-gray-600">
                    Professional gallery with instant access
                  </p>
                </div>
              </div>
            </motion.div>
